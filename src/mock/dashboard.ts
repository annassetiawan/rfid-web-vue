export type DashboardKpi = {
  key: 'delivery' | 'pickup' | 'missing' | 'transit'
  title: string
  value: number
  helper: string
  progress: number
...
export const deliveryChartData: ChartPoint[] = [
  { date: '20/1', total: 0 },
  { date: '23/1', total: 0 },
  { date: '27/1', total: 1 },
  { date: '30/1', total: 0 },
...
export const pickupChartData: ChartPoint[] = [
  { date: '20/1', total: 0 },
  { date: '23/1', total: 0 },
  { date: '27/1', total: 0 },
  { date: '30/1', total: 0 },
...
export const warehouseMapPoints: WarehouseMapPoint[] = [
