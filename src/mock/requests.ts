export type RequestStatus = 'new' | 'approved' | 'rejected' | 'in-progress' | 'canceled'
...
export type LocalRequest = {
  ...
  warehouse: string
  companyName: string
  requestType: 'Tagging' | 'Reprint' | 'Transfer' | 'Retagging'
...
export const localRequestsMock: LocalRequest[] = [
